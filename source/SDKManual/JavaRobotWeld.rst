...
.. code-block:: Java
    ...
    public static int TestSetWeldParam(Robot robot) {
        // 1. Ustaw parametry procesu spawania
        ...
        // 2. Pobierz i wydrukuj grupę parametrów 1
        ...
        // 3. Pobierz i wydrukuj grupę parametrów 2
        ...
        // 4. Ustaw zależność prąd/napięcie i wydrukuj wartość zwracaną
        ...
        // 5. Pobierz i wydrukuj zależność prądu
        ...
        // 6. Pobierz i wydrukuj zależność napięcia
        ...
        // 9. Ustaw parametry wykrywania przerwania łuku i ponownego spawania
        ...
        // 10. Pobierz i wydrukuj parametry wykrywania przerwania łuku
        ...
        // 11. Pobierz i wydrukuj parametry ponownego spawania (zwraca List<Number>)
        ...
        // 12. Ustaw rozszerzone DO i sterowanie w pętli
        robot.SetWeldMachineCtrlModeExtDoNum(17);
        for (int i = 0; i < 5; i++) {
            int[] mode = new int[1];   // Do odbioru wartości wyjściowej
...
.. code-block:: Java
    ...
    * @param mode Tryb sterowania spawarką; 0-tryb jednopokrętłowy DC; 1-tryb jednopokrętłowy impulsowy; 2-tryb JOB; 3-tryb sterowania lokalnego; 4-tryb oddzielny; 5-tryb CC/CV; 6-TIG; 7-CMT
    * @return Kod błędu
    */
...
.. code-block:: Java
    ...
    * @param DIConfig Konfiguracja wejścia rozszerzonego DI; DIConfig[0]-port rozszerzonego DI gotowości spawarki;
...
.. code-block:: Java
    ...
    * @param DOConfig Konfiguracja wyjścia rozszerzonego DO; DOConfig[0]-port rozszerzonego DO rozpoczęcia łuku spawarki;
...
.. code-block:: Java
    ...
    * @param flag Czy wrócić do punktu zerowego cyklu po zakończeniu splotu; 0-nie wracać; 1-wrócić do punktu zerowego cyklu
    * @return Kod błędu
    */
...
.. code-block:: Java
    ...
    /**
    * @brief Ustawia prędkość (rama komendy, niskie opóźnienie)
