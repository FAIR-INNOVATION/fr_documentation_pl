...
为了便于PLC通过不同的工业总线协议（CC-Link IEF Basic、Profinet、Ethernet/IP和EtherCAT）对机器人进行运动控制，在集成式mini控制箱上增加FRH-PCIeN-EC/EIP/CC/PN-RJ-V10板卡、FRJ-PCIeN-EIP/CC/PN-RJ-V10板卡、FRJ-PCIeN-EC/PN/EIP/CC-RJ-V20板卡设备。
...
FRJ-PCIeN-EIP/CC/PN-RJ-V10板卡固件升级
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

板卡进行协议切换时，需进行固件升级。在进行固件升级时，需将板卡的IP地址和笔记本PC的IP地址配置在同一个网段，然后打开“网关工具集”软件->选择需要连接的PC网卡设备->点击右下角“开始”按钮->点击右上角“搜索”按钮，搜索板卡设备。
...
点击左下角“升级”按钮->选中板卡设备->点击右上角“…”按钮，选择需要的协议固件->点击“升级”按钮，等待固件升级完成即可。
...
:download:`附件一：从站模式地址映射表 <../_static/_doc/Control box slave mode address comparison table.xlsx>`
