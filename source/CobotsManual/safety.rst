...
安全速度移动
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
机器人在安全停止触发后，可以在webapp中点击按钮、可配置控制箱CI输入、可配置末端工具End DI输入控制机器人进入安全速度移动状态。在安全速度移动状态中可以在安全速度下点动机器人，或进入拖动模式拖动机器人，以帮助用户排除故障。

在机器人webapp中依次点击“初始设置”、“安全”、“安全停止”，在该页面中找到“安全速度移动”，并将它设置为使能。

.. image:: safety/057.png
   :width: 4in
   :align: center

.. centered:: 图表 7.1-4 打开安全速度移动

此时触发安全停止时，机器人webapp右上角显示“安全停止触发”警告，并显示出“进入安全速度移动”按钮。

.. image:: safety/058.png
   :width: 4in
   :align: center

.. centered:: 图表 7.1-5 进入安全速度移动弹框

点击“进入”按钮，机器人将自动停止LUA程序，并切换至手动模式。同时“进入安全速度移动”按钮更新显示为“已进入”。此时通过末端按钮、按钮盒、webapp等方式控制机器人进入拖动模式拖动机器人，也可以通过webapp或示教器Jog点动机器人。

.. image:: safety/059.png
   :width: 4in
   :align: center

.. centered:: 图表 7.1-6 进入安全速度移动

机器人安全安全速度移动，并在笛卡尔空间点动机器人时，机器人的最大移动速度为设置的安全速度，若当前机器人全局速度设置大于安全速度，机器人点动将自动降速为安全速度。安全速度的设置在“初始设置”、“安全”、“安全速度”中。

机器人安全停止后，除了可以在webapp右上角控制机器人进入安全速度外，还可以通过控制箱CI输入、末端CI输入进入。在webapp中依次点击“初始设置”、“基础”、“I/O设置”、“DI”。配置控制箱某个端口CI或末端工具End DI为“进入安全速度移动”。安全停止触发后，只需要触发配置端口的输入信号，即可进入安全速度移动。

.. image:: safety/060.png
   :width: 6in
   :align: center

.. centered:: 图表 7.1-7 通过按钮进入安全速度移动

仅自动模式安全停止
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
当机器人启用安全停止模式(CR认证、功能安全)，并且搭配示教器三位使能使用时，可以打开“仅自动模式下安全停止”，当机器人安全停止信号触发时，可以在示教器上将机器人切换至手动模式，并在手动模式下Jog点动机器人或进入拖动模式拖动机器人，以帮助用户排除故障。

在机器人webapp中依次点击“初始设置”、“安全”、“安全停止”，在该页面中找到“仅自动模式安全停止”，并将它设置为使能。

.. image:: safety/061.png
   :width: 4in
   :align: center

.. centered:: 图表 7.1-8 仅自动模式安全停止开启

当机器人未启用安全停止模式(CR认证、功能安全)，或未使用示教器时，无法打开“仅自动模式安全停止”功能，此时webapp会报出错误提示“仅自动模式安全停止需打开示教器三位使能”。同时，当禁用安全停止模式或禁用示教器时，“仅自动模式安全停止”功能也将自动关闭。

.. image:: safety/062.png
   :width: 3in
   :align: center

.. centered:: 图表 7.1-9 仅自动模式安全停止开启报错
